...
def getLatestAccouncement(url):
    ...
    try:
        latestAccouncement["title"] = announcmentCards[0].findAll("div", class_="apphub_CardContentNewsTitle")[0].contents[0]
        latestAccouncement["info"] = announcmentCards[0].findAll("div", class_="apphub_CardTextContent")[0].text
